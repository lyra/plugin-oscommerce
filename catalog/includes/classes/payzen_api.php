	...
	class PayzenApi {
		...
		*/
		...
		function getSupportedLanguages() {
			return array(
				'fr' => 'French', 'de' => 'German', 'en' => 'English', 'es' => 'Spanish',
'zh' => 'Chinese', 'it' => 'Italian', 'ja' => 'Japanese', 'pt' => 'Portuguese',
'nl' => 'Dutch', 'sv' => 'Swedish', 'ru' => 'Russian'
			);
		}
...
array('PLN', '985', 2), array('BRL', '986', 2)
		...
		function getSupportedCardTypes() {
			return array(
				'CB' => 'CB', 'VISA' => 'Visa', 'VISA_ELECTRON' => 'Visa Electron', 'MASTERCARD' => 'Mastercard',
'MAESTRO' => 'Maestro', 'E-CARTEBLEUE' => 'E-Carte bleue', 'AMEX' => 'American Express',
'ACCORD_STORE' => 'Carte Privative Accord', 'ACCORD_STORE_SB' => 'Carte Privative Accord (sandbox)',
'ALINEA' => 'Carte Alinéa', 'ALINEA_CDX' => 'Carte Cadeau Alinéa',
'ALINEA_CDX_SB' => 'Carte Cadeau Alinéa (sandbox)', 'ALINEA_SB' => 'Carte Alinéa (sandbox)',
'ONEY' => 'Oney', 'ONEY_SANDBOX' => 'Oney (sandbox)',
'AURORE-MULTI' => 'Aurore Multipaiements', 'BIZZBEE_CDX' => 'Carte Cadeau Bizzbee',
'BIZZBEE_CDX_SB' => 'Carte Cadeau Bizzbee (sandbox)', 'BOULANGER' => 'Carte Boulanger',
'BOULANGER_SB' => 'Carte Boulanger (sandbox)', 'BRICE_CDX' => 'Carte Cadeau Brice',
'BRICE_CDX_SB' => 'Carte Cadeau Brice (sandbox)', 'BUT' => 'But', 'BUYSTER' => 'Buyster',
'CASINO' => 'Banque Casino', 'CDGP' => 'Carte Privilège', 'CDISCOUNT' => 'CDiscount',
'COF3XCB' => 'Cofinoga 3 fois CB', 'COF3XCB_SB' => 'Cofinoga 3 fois CB Sandbox',
'COFINOGA' => 'Cofinoga', 'CONFORAMA' => 'Conforama', 'DINERS' => 'Diners',
'ILLICADO' => 'Carte Illicado', 'ILLICADO_SB' => 'Carte Illicado (sandbox)',
'JCB' => 'JCB', 'LECLERC' => 'Carte Reglo', 'LEROY-MERLIN' => 'Carte Leroy Merlin',
'LEROY-MERLIN_SB' => 'Carte Leroy Merlin (sandbox)', 'NORAUTO_SB' => 'Carte Norauto (sandbox)',
'PAYPAL' => 'Paypal', 'PAYPAL_SB' => 'Paypal Sandbox', 'PAYSAFECARD' => 'PaysafeCard',
'S-MONEY' => 'S-money', 'SOFICARTE' => 'Soficarte', 'SOFINCO' => 'Sofinco', 'SYGMA' => 'Sygma',
'TRUFFAUT_CDX' => 'Carte Cadeau Truffaut', 'V_ME' => 'V.me by Visa', 'SDD' => 'Prélèvement SEPA',
...
if(!@class_exists('PayzenMultiApi', false)) {
	/**
